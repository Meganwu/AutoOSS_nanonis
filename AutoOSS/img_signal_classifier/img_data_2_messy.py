...
dataset_train_list = glob.glob(os.path.join(dataset_path, 'imgs_messy/train/**/*.png'), recursive = True)
dataset_test_list = glob.glob(os.path.join(dataset_path, 'imgs_messy/test/**/*.png'), recursive = True)
