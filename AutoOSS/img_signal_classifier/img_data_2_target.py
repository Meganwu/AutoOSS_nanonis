...
dataset_train_list = glob.glob(os.path.join(dataset_path, 'imgs_target/train/**/*.jpg'), recursive = True)
dataset_test_list = glob.glob(os.path.join(dataset_path, 'imgs_target/test/**/*.jpg'), recursive = True)
...
print('size train_dataset:', len(train_dataset), 'size test_dataset:', len(test_dataset))
