...
class nanonisTCP:
    # def __init__(self, IP='127.0.0.1', PORT=3580, max_buf_size=200, version=99999999):  # 6501
    def __init__(self, IP='127.0.0.1', PORT=6501, max_buf_size=200, version=99999999):  # 6501
    # def __init__(self, IP='144.213.50.118', PORT=6501, max_buf_size=200, version=99999999):  # 6501
        """
        Parameters
